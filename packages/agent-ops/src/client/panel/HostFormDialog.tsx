        ...
        <div className={css.field}>
          ...
          <div className={css.radioRow}>
            <label className={css.radioLabel}>
              <input type="radio" name="agent-ops-auth" checked={form.authKind === 'key'} onChange={() => { set('authKind', 'key') }} />
              {tt('form.auth.key')}
            </label>
            <label className={css.radioLabel}>
              <input type="radio" name="agent-ops-auth" checked={form.authKind === 'password'} onChange={() => { set('authKind', 'password') }} />
